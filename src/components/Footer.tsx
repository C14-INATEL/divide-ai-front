      ...
      <div className="hidden md:flex items-center gap-1.5 flex-wrap justify-center">
        {[
          ...
          <span key={s.gh}>
            ...
            {i < arr.length - 1 && (
              <span className="text-base-content/20 ml-1.5">·</span>
            )}
          </span>
        ))}
      </div>

      <div className="hidden lg:flex items-center gap-1.5 shrink-0 text-base-content/30">
        <span className="text-base-content/20">Orient.</span>
        <span>Christopher Lima</span>
        <span className="text-base-content/20">·</span>
        <span>Marcelo Vilela</span>
      </div>
    </footer>
  );
}
