    ...
    return (
        <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
            <aside>
                ...
                <p>
                    Trabalho de C14 - Engenharia de Software
                    <br />
                    Alunos do primeiro semestre de 2026
                </p>
            </aside>
            <nav></nav>
            <nav>
                <h6 className="footer-title">Alunos</h6>
                <a
                    className="link link-hover"
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/DaviRosimES"
                >
                    Davi Rosim
                </a>
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/henrique-pizzoni"
                >
                    Henrique Pizzoni
                </a>
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/joaopedromsantos"
                >
                    João Pedro Santos
                </a>
                <a
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/LeonardoFerreira23"
                    >
                    Leonardo Ferreira
                </a>
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://github.com/tiagobbandrade"
                >
                    Tiago Andrade
                </a>
            </nav>
            <nav>
                <h6 className="footer-title">Orientadores</h6>
                <a className="link link-hover">Christopher Lima</a>
                <a className="link link-hover">Marcelo Vilela</a>
            </nav>
        </footer>
    );
};
